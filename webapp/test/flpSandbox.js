					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Stock Overview",
									"targetURL": "#smartstock-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"smartstock-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartstock",
									"url": sap.ui.require.toUrl("smartstock")
								}
							}
						}
					}
